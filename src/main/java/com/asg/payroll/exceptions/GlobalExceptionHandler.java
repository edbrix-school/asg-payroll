package com.asg.payroll.exceptions;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(com.asg.payroll.exceptions.ValidationException.class)
    public ResponseEntity<?> handleShippingValidationException(com.asg.payroll.exceptions.ValidationException ex) {
        Map<String, Object> errors = new HashMap<>();
